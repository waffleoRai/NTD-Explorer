...
public class CSSManager extends TypeManager{
	
	//Definition
	public static final int DEF_ID = 0x2e435353;
	public static final String DEFO_ENG_NAME = "Cascading Style Sheet Document";
	
	private static CSSFileDefinition stat_def;
	
	public static class CSSFileDefinition implements FileTypeDefinition{
		...
		public String getDefaultExtension() {return "css";}
		
	}
	
	public static CSSFileDefinition getDefinition(){
		if(stat_def == null) stat_def = new CSSFileDefinition();
		return stat_def;
	}
	
	//Loader
	public static class CSSFileDefLoader implements NTDTypeLoader{

		public TypeManager getTypeManager() {return new CSSManager();}
		public FileTypeDefinition getDefinition() {return CSSManager.getDefinition();}
	...
	public FileTypeNode detectFileType(FileNode node) {
		...
		if(node.getFileName().endsWith(".css")) return new FileTypeDefNode(getDefinition());
		return null;
	}
