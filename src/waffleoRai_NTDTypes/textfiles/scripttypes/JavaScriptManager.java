...
public class JavaScriptManager extends TypeManager{

	//Definition
	public static final int DEF_ID = 0x6e736372;
	public static final String DEFO_ENG_NAME = "JavaScript Document";
	
	private static JSFileDefinition stat_def;
	
	public static class JSFileDefinition implements FileTypeDefinition{
		...
		public FileClass getFileClass() {return FileClass.CODESCRIPT;}
		public int getTypeID() {return DEF_ID;}
		public void setDescriptionString(String s) {str = s;}
		public String getDefaultExtension() {return "js";}
		
	}
	
	public static JSFileDefinition getDefinition(){
		if(stat_def == null) stat_def = new JSFileDefinition();
		return stat_def;
	}
	
	//Loader
	public static class JSFileDefLoader implements NTDTypeLoader{

		public TypeManager getTypeManager() {return new JavaScriptManager();}
		public FileTypeDefinition getDefinition() {return JavaScriptManager.getDefinition();}
	...
	public FileTypeNode detectFileType(FileNode node) {
		...
		if(node.getFileName().endsWith(".js")) return new FileTypeDefNode(getDefinition());
		return null;
	}
