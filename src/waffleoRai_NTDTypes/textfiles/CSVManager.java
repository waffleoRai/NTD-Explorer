...
public class CSVManager extends TypeManager{

	//Definition
	public static final int DEF_ID = 0x2c737654;
	public static final String DEFO_ENG_NAME = "Comma Separated Values Table";
	
	public static final int CHAR_LOAD_LIMIT = 0x100000;
	
	private static CSVFileDefinition stat_def;
	
	public static class CSVFileDefinition implements FileTypeDefinition{
		...
		public FileClass getFileClass() {return FileClass.DAT_TABLE;} //Technically I made this class for bin tables, but eh.
		public int getTypeID() {return DEF_ID;}
		public void setDescriptionString(String s) {str = s;}
		public String getDefaultExtension() {return "csv";}
		public String toString(){return FileTypeDefinition.stringMe(this);}
		
	}

	public static CSVFileDefinition getDefinition(){
		if(stat_def == null) stat_def = new CSVFileDefinition();
		return stat_def;
	}
	
	//Loader
	public static class CSVFileDefLoader implements NTDTypeLoader{

		public TypeManager getTypeManager() {return new CSVManager();}
		public FileTypeDefinition getDefinition() {return CSVManager.getDefinition();}
	...
	public FileTypeNode detectFileType(FileNode node) {
		...
		if(node.getFileName().endsWith(".csv")) return new FileTypeDefNode(getDefinition());
		return null;
	}
